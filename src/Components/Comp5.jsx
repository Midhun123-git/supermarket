    ...
    <div className='w-[140px]  rounded-3xl
     ...
     flex flex-col justify-between'>
      ...
      <div className='h-[118px] bg-[#E5E5E5]
        ...
        {/* DISCOUNT BADGE (Only if per exists) */}
        {per && (
          <div className='absolute top-2 left-2 z-9'>
            <svg width="27" height="43" viewBox="0 0 27 43" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <linearGradient id="paint0_linear_1_236" x1="27.2368" y1="12.1315" x2="-0.233505" y2="39.6018" gradientUnits="userSpaceOnUse">
                  ...
                  <stop offset="0.435" stopColor="#39CB77"/>
                  <stop offset="1" stopColor="#168946"/>
                </linearGradient>
              </defs>
            </svg>
          </div>
        ...
        {/* TOP RIGHT BUTTON */}
        <div className='absolute top-2 right-2 z-9'>
          {isCounter ? (
      ...
      {/* TITLE (Fixed Visibility - No UI Change) */}
      <p className='font-medium text-[14px] text-[#1E1E1E] p-1 leading-4'>
        {title}
      </p>
      ...
      <div className='mt-2'>
        ...
        {oldPrice && (
          <div className='flex justify-end mt-1'>
            <p className='line-through text-[#8F8F8F] mr-1'>
              {oldPrice}
            </p>
          </div>
        )}
